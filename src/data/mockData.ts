...
export const teaGardenZones: TeaGardenZone[] = [
  {
    id: 'dongpo-3',
    name: '东坡 3 号',
    position: [5.6, 0.48, -2.2],
    cardOffset: [-1.35, 0.24],
    cameraPose: { position: [8.6, 5.5, 4.4], target: [5.05, 0.2, -1.8], fov: 34 },
    markerTone: 'gold',
    status: '重点巡护',
    risk: '叶面湿度偏高',
    area: '28.6 亩',
  ...
  },
  {
    id: 'qingya-1',
    name: '青芽 1 号',
    position: [-2.5, 0.35, -0.45],
    cardOffset: [-0.68, 0.4],
    cameraPose: { position: [1.9, 5.2, 7.2], target: [-2.1, 0.16, -0.3], fov: 35 },
    markerTone: 'mint',
    status: '生长稳定',
    risk: '适宜采摘',
    area: '35.2 亩',
  ...
  },
  {
    id: 'yunjing-2',
    name: '云径 2 号',
    position: [5.45, 0.22, 2.35],
    cardOffset: [-1.35, -0.16],
    cameraPose: { position: [8.3, 4.85, 6.8], target: [5.05, 0.12, 2.05], fov: 35 },
    markerTone: 'cyan',
    status: '水分适宜',
    risk: '巡园正常',
    area: '19.8 亩',
  ...
  },
  {
    id: 'beipo-1',
    name: '北坡 1 号',
    position: [-5.45, 0.28, 2.45],
    cardOffset: [0.52, 0.28],
    cameraPose: { position: [-8.25, 5.15, 6.5], target: [-5.0, 0.16, 2.1], fov: 35 },
    markerTone: 'mint',
    status: '光照平稳',
    risk: '轻度关注',
    area: '24.1 亩',
  ...
  },
  {
    id: 'nangu-1',
    name: '南谷 1 号',
    position: [0.55, 0.2, 3.85],
    cardOffset: [-1.05, 0.22],
    cameraPose: { position: [4.3, 5.15, 7.85], target: [0.5, 0.14, 3.3], fov: 34 },
    markerTone: 'cyan',
    status: '常规巡护',
    risk: '长势均衡',
    area: '22.4 亩',
